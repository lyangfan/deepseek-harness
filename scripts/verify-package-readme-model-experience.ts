...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/evidence/evidence-service': { kind: 'none', reason: 'Deterministic read-only query remote; the semantic lane (evidence-core) owns every model dispatch; this service registers no prompts, schemas, or Tools.' },
  'packages/client/ui-evidence': { kind: 'none', reason: 'Browser-only view plugin; renders remote query results; registers no model-visible surfaces.' },
