...
| [`evidence/evidence-core`](subsystems/evidence.md) | Deterministic immutable Evidence projection over persisted Session events | private function plugin, no key |
